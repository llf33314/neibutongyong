...
<template>
  <div class="manage-user">
    ...
    <div>
      <el-dialog :title="dialogOpe.name" :visible.sync="dialogFormVisible" :modal-append-to-body="false">
    ...
    <div>
      <el-dialog title="关联信息" :visible.sync="dialogVisible" class="yong" :modal-append-to-body="false">
    ...
    <div>
      <el-dialog title="关联员工" :visible.sync="dialogStaffVisible" :modal-append-to-body="false">
    ...
    <div>
      <el-dialog title="关联角色" :visible.sync="dialogRoleVisible" :modal-append-to-body="false">
