...
<script>
import { requestListStaff, requestAddStaff, requestModifyStaff, requestDelStaff, requestQuitStaff, requestListDepartment } from "../api/api";
export default {
  data() {
    return {
      staffListReq: {
  ...
  watch:{
    'staffListReq.staffStatus': function(val) { //此处不要使用箭头函数
        this.getStaffList();
    }
  }
};
